...
allHrsArray.setAttribute("class","hr");
// Change the background of all the hr to "antiquewhite" using for of loop.
for(elm of allHrsArray){
  allHrsArray.setAttribute("background","hr");
}
// Change the 'border-radius' of all the hr to "5px" using array.
for(elm of allHrsArray){
  allHrsArray.setAttribute("border-radius","hr");
}
...
allHrsArray.setAttribute("image","2px solid purple");
